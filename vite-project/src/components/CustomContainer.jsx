      ...
      <div className="w-5/6 h-48 flex-shrink-0 rounded-lg flex flex-col items-center justify-end p-2  ">
        <div>
          <div className="flex w-[900px] justify-between text-2xl invisible lg:visible  ">
            <div ref={baseRefs.current[0]} className="invisible">Spirituality</div>
            <div ref={baseRefs.current[1]} className="invisible">Technology</div>
            <div ref={baseRefs.current[2]} className="invisible">Business</div>
            <div ref={baseRefs.current[3]} className="invisible">Sports</div>
          </div>
          <div >
